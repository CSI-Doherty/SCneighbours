...
test_that("Seurat graphs are valid", {
  expect_s4_class(SCneighbours::check_single_cell_object(seu, sce.graph, 'umap')[['graph']], "dgCMatrix")
  expect_s4_class(SCneighbours::check_single_cell_object(seu, seu.graph)[['graph']], "dgCMatrix")
  expect_s4_class(SCneighbours::check_single_cell_object(seu)[['graph']], "dgCMatrix")
})


test_that("SCE graphs are valid", {
  expect_s4_class(SCneighbours::check_single_cell_object(sce, seu.graph, 'UMAP')[['graph']], "dgCMatrix")
  expect_s4_class(SCneighbours::check_single_cell_object(sce, sce.graph, 'UMAP')[['graph']], "dgCMatrix")
})
